...
Gem::Specification.new do |s|
  ...
  s.test_files = ["features/support/env.rb", "features/support/models/theta.rb", "features/support/db/fixtures/thetas.rb", "features/support/db/migrations/create_thetas.rb", "features/step_definitions/common_steps.rb", "features/step_definitions/datetime_delta_steps.rb", "features/datetime_deltas.feature", "features/support/database.example.yml", "spec/spec.opts", "spec/spec_helper.rb", "spec/thinking_sphinx", "spec/thinking_sphinx/deltas", "spec/thinking_sphinx/deltas/datetime_delta_spec.rb"]
